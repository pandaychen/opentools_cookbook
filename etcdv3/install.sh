...
##build a local-etcd-server-cluster
#pandaychen
...
./etcd --name cd0 --initial-advertise-peer-urls http://127.0.0.1:2380 \
  ...
  --advertise-client-urls http://127.0.0.1:2379,http://127.0.0.1:2379 \
...
./etcd --name cd1 --initial-advertise-peer-urls http://127.0.0.1:2480 \
  ...
  --listen-client-urls http://127.0.0.1:2479,http://127.0.0.1:2479 \
  --advertise-client-urls http://127.0.0.1:2479,http://127.0.0.1:2479 \
  --initial-cluster-token etcd-cluster-1 \
  --initial-cluster cd0=http://127.0.0.1:2380,cd1=http://127.0.0.1:2480,cd2=http://127.0.0.1:2580 \
  --initial-cluster-state new
  ;;
...
./etcd --name cd2 --initial-advertise-peer-urls http://127.0.0.1:2580 \
  ...
  --listen-client-urls http://127.0.0.1:2579,http://127.0.0.1:2579 \
  --advertise-client-urls http://127.0.0.1:2579,http://127.0.0.1:2579 \
  --initial-cluster-token etcd-cluster-1 \
  --initial-cluster cd0=http://127.0.0.1:2380,cd1=http://127.0.0.1:2480,cd2=http://127.0.0.1:2580 \
  --initial-cluster-state new
  ;;
